...
public class fish1 : MonoBehaviour
{
    ...
    public float sizeIncreaseAmount = 0.25f; // Amount to increase size each time the fish eats

    private Rigidbody2D rb;
    private bool movingLeft = true; // Indicates current direction
    ...
    private void MoveNaturally()
    {
        ...
        rb.velocity = new Vector2((movingLeft ? -1 : 1) * speed, verticalMovement);
    ...
    {
        Vector2 direction = movingLeft ? Vector2.right : Vector2.left;
